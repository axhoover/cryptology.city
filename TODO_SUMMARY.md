...
- [ ] [Content] 6 relation bullets arrived on `main` after the reductions audit ran (Sho97 generic-group bounds on CDH/DDH/DLOG, the CCG+94 ROM separation, YYS25 on homomorphic-encryption, and two Kha26 bullets on secret-sharing). They are still prose and were never put through the migration — they need reduction or barrier pages like the rest — _source: git log 75f2542..043f406_
