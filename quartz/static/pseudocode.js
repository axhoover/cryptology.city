          ...
          module.exports = {
            ...
            renderToString: function (input, options) {
              ...
              if (
                ...
                console.warn(
                  "`renderToString` is not fully supported on MathJax backend below 3.0.\n" +
...
*/
          ...
          Lexer.prototype._matchText = function (text) {
            ...
            if (utils.isString(text))
              ...
              return text.some(
                (str) =>
                  str.toLowerCase() === this._nextAtom.text.toLowerCase(),
              );
          };
      ...
      4: [
        function (require, module, exports) {
          ...
          ParseNode.prototype.addChild = function (childNode) {
            if (!childNode) throw new Error("Argument must not be null");
          ...
          Parser.prototype._parseAlgorithmInner = function () {
            ...
            while (true) {
              ...
              if (this._lexer.accept("func", "algname")) {
                this._lexer.expect("open");
                var prefix = "";
                while (
                  this._lexer._nextAtom.type !== "close" &&
                  this._lexer._nextAtom.type !== "EOF"
                ) {
                  this._lexer._next();
                  prefix += this._lexer._currentAtom.text || "";
                }
                this._lexer.expect("close");
                algNode.value = prefix;
                continue;
              }
...
*/
          ...
          TextEnvironment.prototype._renderCloseText = function (
            node,
            backend,
          ) {
                ...
                case "math":
                  if (typeof backend === "undefined") {
                    ...
                    if (backend.version < 3) {
                      ...
                      this._html.putHTML(
                        backend.driver.tex2chtml(text, { display: false })
                          .outerHTML,
                      );
                    }
                  } else {
...
*/
          ...
          function Renderer(parser, options) {
            ...
            try {
              if (typeof MathJax === "undefined") MathJax = require("mathjax");
            } catch (_) {
              /* ignore */
            }
          ...
          Renderer.prototype._beginBlock = function () {
            ...
            if (this._options.scopeLines) blockIndent /= 2;
          ...
          Renderer.prototype._newLine = function () {
            ...
            if (this._blockLevel > 0) {
              ...
              var extraIndentSize = this._options.lineNumber
                ? indentSize * 1.25
                : 0;
              extraIndentSize += this._options.scopeLines
                ? indentSize * 0.1
                : 0;
          ...
          Renderer.prototype._buildTree = function (node) {
            ...
            switch (node.type) {
              ...
              case "algorithm":
                ...
                var lastCaptionNode;
                this._algPrefix = node.value || null;
                ...
                this._endGroup();
                this._algPrefix = null;
                break;
              case "algorithmic":
                // Check if we need to add additional classes for the provided options
                var divClasses = this._options.lineNumber
                  ? " with-linenum "
                  : "";
                divClasses += this._options.scopeLines
                  ? " with-scopelines "
                  : "";
              ...
              case "caption":
                this._newLine();
                if (this._algPrefix) {
                  this._typeKeyword(this._algPrefix + " ");
                } else {
                  this._typeKeyword(
                    this._options.titlePrefix +
                      " " +
                      Renderer.captionCount +
                      " ",
                  );
