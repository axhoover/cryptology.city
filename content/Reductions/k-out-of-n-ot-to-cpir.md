...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — the quote equates 1-out-of-$n$ OT with single-server SPIR, not cPIR, and the title's $k$-out-of-$n$ contradicts the 1-out-of-$n$ hypothesis. As an equivalence with cPIR it is false: trivial download is a cPIR under the wiki's definition and implies nothing, and non-trivial cPIR ⇒ OT (DMO00) does not reverse, since 1-out-of-$n$ OT has no sublinear-communication bound. See [[symmetric-private-information-retrieval-single-server-to-ot]] and [[cpir-to-ot-dmo00]].
