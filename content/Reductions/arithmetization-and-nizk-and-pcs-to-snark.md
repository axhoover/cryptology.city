...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — no known theorem takes a NIZK, a polynomial commitment scheme and an arithmetization to a SNARK; the construction behind the migrated sentence (arithmetize to a polynomial IOP, compile with an extractable PCS, apply Fiat–Shamir) uses no NIZK. See [[arithmetization-and-pcs-to-snark-kzg10]].
