...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — NIZK for NP from plain LWE is Peikert–Shiehian (CRYPTO 2019): Fiat–Shamir with an LWE-based correlation-intractable hash family in the CRS model, not signatures. The edge distilled here is at best the composite LWE ⇒ SIS ⇒ GPV hash-and-sign in the ROM, whose second link is already recorded; `hash-and-sign-signature` has no page. See [[isis-inhomogeneous-sis-to-ds-gpv08]].
