...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — [[KZG10 - Constant-size commitments to polynomials and their applications|KZG10]] constructs a polynomial commitment scheme and contains no SNARK theorem, and [[Gro16 - On the Size of Pairing-based Non-interactive Arguments|Gro16]] compiles a linear non-interactive proof for QAPs into pairings without KZG. A polynomial commitment alone does not yield a SNARK: Plonk (eprint 2019/953) and Marlin (Eurocrypt 2020) compile a polynomial IOP and a polynomial commitment via Fiat–Shamir in the random-oracle model, so this single-hypothesis edge duplicates existing pages with a wrong hypothesis and wrong sources. See [[arithmetization-and-pcs-to-snark-kzg10]] and [[pcs-to-snark]].
