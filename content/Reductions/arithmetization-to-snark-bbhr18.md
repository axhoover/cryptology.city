...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — an AIR arithmetization alone does not yield a SNARK; the BBHR18 STARK additionally needs the FRI proximity test and a random-oracle compilation. The second quote (PLONKish ⇒ universal SNARKs, labelled `— standard`) is attributable to [[GWC19 - PLONK Permutations over Lagrange-bases for Oecumenical Noninteractive arguments of Knowledge|GWC19]] and belongs to the {arithmetization, PCS} edge. See [[arithmetization-and-fri-fast-reed-solomon-iop-of-proximity-to-snark-bbhr18]].
