...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — AIR alone does not yield a SNARK; the BBHR18 STARK also needs the FRI proximity test and a random-oracle compilation. The PLONKish quote is attributable to [[GWC19 - PLONK Permutations over Lagrange-bases for Oecumenical Noninteractive arguments of Knowledge|GWC19]] and belongs on [[arithmetization-and-pcs-to-snark-kzg10]]. See [[arithmetization-and-fri-fast-reed-solomon-iop-of-proximity-to-snark-bbhr18]].
