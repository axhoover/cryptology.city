...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — not a theorem: SZK ⊆ AM ∩ coAM (Fortnow 1987; Aiello–Håstad 1991), so IP ⊆ SZK with IP = PSPACE would collapse the polynomial hierarchy. [[BGG+90 - Everything Provable is Provable in Zero-Knowledge|BGG+90]] prove that every language in IP has a computational zero-knowledge proof assuming secure probabilistic encryption (OWF suffice by later work): the conjunctive edge {IP, OWF} ⇒ CZK. See [[czk-to-ip-bgg-90]].
