...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — $\classcoNP \subseteq \classAM$ is open and would collapse the polynomial hierarchy to its second level (Boppana–Håstad–Zachos, IPL 1987). [[GS86 - Private Coins versus Public Coins in Interactive Proof Systems|GS86]] prove that every $k$-round private-coin interactive proof is simulated by a $(k+2)$-round Arthur–Merlin protocol and give no AM protocol for coNP. See [[conp-to-coam]].
