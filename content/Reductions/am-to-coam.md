...
- Sourcing pass (2026-09), **not fixed**: claim judged incorrect as stated — $\classAM = \classcoAM$ is open and believed false: since $\classNP \subseteq \classAM$, it would give $\classcoNP \subseteq \classAM$ and collapse the polynomial hierarchy to its second level (Boppana–Håstad–Zachos; see [[BM88 - Arthur-merlin games A randomized proof system and a hierarchy of complexity classes|BM88]]).
