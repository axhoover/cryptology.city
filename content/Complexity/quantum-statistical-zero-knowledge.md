...
- **Quantum state distinguishability** (QSD): given two quantum circuits $Q_0$ and $Q_1$ of the same size, are their output states on the all-zeros input (a) at least $2/3$ apart in trace distance, or (b) at most $1/3$ apart? QSD is QSZK-complete: [[Wat02 - Limits on the Power of Quantum Statistical Zero-Knowledge|Wat02]] proves it complete for the honest-verifier class, which equals QSZK — [[Wat06 - Zero-knowledge against quantum attacks|Wat06]]. This is the quantum analogue of the Statistical Difference problem, which is SZK-complete.

## Known relationships

- $\classSZK \subseteq \classQSZK$: a classical SZK proof system is in particular an honest-verifier quantum one, and the honest-verifier class equals QSZK — [[Wat06 - Zero-knowledge against quantum attacks|Wat06]].
- QSZK is closed under complement: $\mathbf{coQSZK} = \classQSZK$ — [[Wat02 - Limits on the Power of Quantum Statistical Zero-Knowledge|Wat02]] for the honest-verifier class, which equals QSZK — [[Wat06 - Zero-knowledge against quantum attacks|Wat06]]. This mirrors the classical fact that $\classSZK$ is closed under complement.
